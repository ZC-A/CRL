...
from .attention_memory_simplified import Attention_Memory_Simplified
import torch
...
class Manager(object):
    ...
    def train_mem_model(self, args, encoder, attention, mem_data, proto_mem, epochs, seen_relations):
        ...
        optimizer = self.get_optimizer(args, encoder, attention)
        def train_data(data_loader_, name = "", is_mem = False):
            losses = []
            kl_losses = []
            td = tqdm(data_loader_, desc=name)
    ...
    @torch.no_grad()
    def evaluate_strict_model(self, args, encoder, attention, test_data, protos4eval, featrues4eval, seen_relations):
    ...
    def train(self, args):
        ...
        for i in range(args.total_round):
            ...
            for steps, (training_data, valid_data, test_data, current_relations, historic_test_data, seen_relations) in enumerate(sampler):
                ...
                attention = Attention_Memory_Simplified(mem_slots=len(seen_relations),
